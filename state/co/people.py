...
class COLegislatorScraper(Scraper, LXMLMixin):
    ...
    def scrape(self, chamber=None):
        ...
        if chamber:
            ...
            co_internal_chamber_ids = [CHAMBER_TO_CO_INTERNAL_CHAMBER_ID['lower'],
        ...
        for co_internal_chamber_id in co_internal_chamber_ids:
            chamber = ('upper' if co_internal_chamber_id == CHAMBER_TO_CO_INTERNAL_CHAMBER_ID[
                'upper'] else 'lower')
            filtered_legislators_page_url = (
                '{legislators_url}/?field_chamber_target_id={internal_chamber_id}'.format(
